...
void loop() {
    pid.setValue = 300.0;
    float speed = pidRealize(pid.setValue);
    // Serial.print("c:");
    // Serial.print(pid.count);Serial.print("   ");
    Serial.print("V:");
    Serial.print(pid.setValue);Serial.print("   ");
    Serial.print("s:");
    Serial.println(speed, 6);
    // speed < pid.setValue - 1 ? pid.count++ : pid.count;
    delay(200);
}
